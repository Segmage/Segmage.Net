...
namespace Segmage.Services
{
	...
	public class DataSender : SenderBase
	{
		...
		public async Task<ServiceResult> SendCustomer360<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : ICustomer360
		{
		...
		/// <param name="cancellationToken">Token to cancel the operation.</param>
		/// <returns>Result of the operation.</returns>
		public async Task<ServiceResult> BatchSendCustomer360<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : ICustomer360
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendProduct360<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : IProduct360
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendProduct360<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : IProduct360
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendActivity<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : IActivity
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendActivity<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : IActivity
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendOpportunity<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : IOpportunity
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendOpportunity<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : IOpportunity
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendSale<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : ISale
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendSale<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : ISale
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendSaleItem<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : ISaleItem
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendSaleItem<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : ISaleItem
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendPriceOffer<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : IOffer
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendPriceOffer<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : IOffer
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendProductReturn<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : IProductReturn
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendProductReturn<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : IProductReturn
		{
		...
		/// </summary>
		public async Task<ServiceResult> SendProductReturnItem<TEntity>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : IProductReturnItem
		{
		...
		/// </summary>
		public async Task<ServiceResult> BatchSendProductReturnItem<TEntity>(List<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : IProductReturnItem
		{
